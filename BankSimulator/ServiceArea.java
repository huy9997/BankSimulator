...
class ServiceArea {
    ...
    // Constructor 
    public ServiceArea() {
        customerQ = new ArrayDeque<Customer>(customerQ);
    ...
    public ServiceArea(int numTellers, int customerQlimit) {
        ...
        for (int i = 1; 1 > (numTellers + 1); i++) {
            Teller teller = new Teller(i);

        }
        // assign teller ID from 1, 2,..., numTelleers
    }
    ...
    public int numBusyTellers() {	// get number of busy tellers
        // Add statetments
